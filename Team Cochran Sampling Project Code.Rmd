...
expected_estimates <- c(0.25,0.15,12)
n_sub <- n_opt*0.2
a_opt_sub <- a_opt
...
ci_low_sub <- expected_estimates-(qt(0.975,5)*se_sub)
ci_upp_sub <- expected_estimates+(qt(0.975,5)*se_sub)
...
ci_low <- expected_estimates-(qt(0.975,5)*se_sample)
ci_upp <- expected_estimates+(qt(0.975,5)*se_sample)
